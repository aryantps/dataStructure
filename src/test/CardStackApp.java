...
// imported from https://raw.githubusercontent.com/dlbunker/ps-data-structure-helpers/master/src/java/CardStackApp.java
public class CardStackApp {
    BasicStack<String> stack;

    {
        stack = new BasicStack<String>();
    }
    ...
    public void containsCard(String card) {
        System.out.println(stack.ifContains(card));
    }
