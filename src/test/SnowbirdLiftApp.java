...
public class SnowbirdLiftApp {
    ...
    public void runLift() {
        ...
        System.out.println("Lift has Mary and Anna on it: " + gad2Lift.ifContains(new Gad2Chair("Mary", "Anna")));

        //who's at the 2nd position - remember 0 based index
        System.out.println("2nd chair has: " + gad2Lift.peekAt(1).listChairRiders());
